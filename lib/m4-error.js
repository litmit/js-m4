...
function M4Error() {
    ...
    if (typeof template === 'undefined') template = 'unknown error #' + code + ', arguments:';
...
M4Error.Message[Code.W_TOO_FEW_ARGS] =
    'too few arguments to builtin `%s\', %d required';
M4Error.Message[Code.W_BAD_BUILTIN] =
    'undefined builtin `%s\'';
M4Error.Message[Code.W_BAD_DEBUG_FLAGS] =
    '%s';
