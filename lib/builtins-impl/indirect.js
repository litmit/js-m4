...
function builtin_builtin(name/*,args*/)
{
   ...
   else
   {
      ...
      {
         if ( !builtinDescr.dynArgs && args.length > builtinDescr.fn.length ) 
         {
            this.error('M4_TOO_MANY_ARGS', macroName, builtinDescr.fn.length);
         }

         var res = builtinDescr.fn.apply(this, args);
